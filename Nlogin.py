...
settings = {
    ...
    "welcome":"สวัสดีคนมาใหม่\n\nตั้งข้อความต้อนรับด้วยคับ\ ─═हই♞ωபԾΩ ❼ஆ้ণ♞ইह═─ ŚẾL₣ВΌŦ",
    "kick":"งิเตะทมอยยย😂\ ─═हই♞ωபԾΩ ❼ஆ้ণ♞ইह═─ ŚẾL₣ВΌŦ",
    "bye":"ไปซ่ะละ ลาก่อยยย\ ─═हই♞ωபԾΩ ❼ஆ้ণ♞ইह═─ ŚẾL₣ВΌŦ",
    ...
    "message":"บัญชีนี้ถูกป้องกันโดย ─═हই♞ωபԾΩ ❼ஆ้ণ♞ইह═─ ŚẾL₣ВΌŦ ระบบได้บล็อคคุณอัตโนมัติ!",
    "comment":"""ŚẾL₣ВΌŦ BY:
╔══════════════┓
     ♞ωபԾΩ ❼ஆ้ণ♞
        ŚẾL₣ВΌŦ
...
#===========
                    ...
                    line.sendMessage(to,"(｡◕‿◕｡)\nบอทยังทำงานคับท่าน😁")
		    line.sendMessage(to,"─═हই♞ωபԾΩ ❼ஆ้ণ♞ইह═─")
#==============================================================================#
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                               ...
                               mi_d = Mids[:33]
                               line.createGroup(" ─═हই♞ωபԾΩ ❼ஆ้ণ♞ইह═─ ",mi_d)
                               line.sendText(msg.to,,("[─═हই♞ωபԾΩ ❼ஆ้ণ♞ইह═─ LÍŇỀ]")
                               line.createGroup("─═हই♞ωபԾΩ ❼ஆ้ণ♞ইह═─  ",mi_d)
                               line.sendText(msg.to,"[ ─═हই♞ωபԾΩ ❼ஆ้ণ♞ইह═─   LÍŇỀ]")
                               line.createGroup("─═हই♞ωபԾΩ ❼ஆ้ণ♞ইह═─  ",mi_d)
                               line.sendText(msg.to,"[─═हই♞ωபԾΩ ❼ஆ้ণ♞ইह═─ LÍŇỀ]")
                               line.createGroup("─═हই♞ωபԾΩ ❼ஆ้ণ♞ইह═ ",mi_d)
                               line.sendText(msg.to,"[─═हই♞ωபԾΩ ❼ஆ้ণ♞ইह═─ ]")
                               line.createGroup("─═हই♞ωபԾΩ ❼ஆ้ণ♞ইह═─  ",mi_d)
                               line.sendText(msg.to,"[─═हই♞ωபԾΩ ❼ஆ้ণ♞ইह═─ LÍŇỀ]")
                               line.createGroup(" ─═हই♞ωபԾΩ ❼ஆ้ণ♞ইह═─ ",mi_d)
                               line.sendText(msg.to,"[─═हই♞ωபԾΩ ❼ஆ้ণ♞ইह═─ LÍŇỀ]")
